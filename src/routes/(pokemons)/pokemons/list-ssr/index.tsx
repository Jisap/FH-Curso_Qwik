...
export default component$(() => {
  ...
  const modalVisible = useSignal(false);                    // Estado
  ...
  const showModal = $(( id:string, name: string ) => {      // Funciones que cambian el estado
    modalPokemon.id = id;
  ...
  return (
    <>
      ...
      <Modal 
          showModal={ modalVisible.value } // Se envían las funciones que cambian el estado
          closeFn={ closeModal }
          persistent={ true }
          //size
      >
